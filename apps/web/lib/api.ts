...
const v = { version: "2.3.1", pubspec: { name: "aurora_ui", version: "2.3.1", homepage: "https://example.com/aurora-ui", repository: "https://github.com/example/aurora-ui", environment: { sdk: ">=3.4.0 <4.0.0", flutter: ">=3.22.0" }, dependencies: { flutter: { sdk: "flutter" } } }, publishedAt: "2026-07-16T08:30:00.000Z", publishedBy: "platform-team", sdk: { dart: ">=3.4.0 <4.0.0", flutter: ">=3.22.0" }, platforms: ["android", "ios", "web", "linux", "macos", "windows"], archiveSha256: "0a4cc3d8f1eeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeee", retractedAt: null, prerelease: false, releaseChannel: "stable" as const, sourceType: "native" as const };
